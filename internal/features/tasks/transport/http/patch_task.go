...
import (
	...
	core_http_types "github.com/MulLoMaH/TODO_list.git/internal/core/transport/http/types"
)
...
func (r *PatchTaskRequest) Validate() error {
	...
	if r.Completed.Set {
		if r.Completed.Value == nil {
			return fmt.Errorf("'campleted' can't be NULL")
		}
	}
...
// @Description         2. **Явно передано значение**: `"description": "Утром прогуляться с собакой"`
...
// @Success             200 {object} internal_features_tasks_transport_http.TaskDTOResponse "Успешно измененная задача"
